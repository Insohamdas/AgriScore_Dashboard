        ...
        <div className={`w-full max-w-md transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="flex gap-4 mb-8">
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-3 py-3.5 bg-white border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all text-slate-700 font-medium shadow-sm">
            ...
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-3 py-3.5 bg-[#1877F2] rounded-xl hover:bg-[#166FE5] transition-all font-medium text-white shadow-sm">
